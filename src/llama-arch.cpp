...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DECISION_HEAD_BLOCK_COUNT,             "%s.decision_head.block_count"             },
    { LLM_KV_DECISION_HEAD_QTYPE_TOKEN_IDS,         "%s.decision_head.qtype_token_ids"         },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DHEAD_ATTN_NORM,                        "dhead.%d.attn_norm" },
    { LLM_TENSOR_DHEAD_ATTN_QKV,                         "dhead.%d.attn_qkv" },
    { LLM_TENSOR_DHEAD_ATTN_OUT,                         "dhead.%d.attn_output" },
    { LLM_TENSOR_DHEAD_FFN_NORM,                         "dhead.%d.ffn_norm" },
    { LLM_TENSOR_DHEAD_FFN_UP,                           "dhead.%d.ffn_up" },
    { LLM_TENSOR_DHEAD_FFN_DOWN,                         "dhead.%d.ffn_down" },
    { LLM_TENSOR_QTYPE_EMBD,                             "qtype_embd" },
    { LLM_TENSOR_CLASS_PROJ_1,                           "class_proj.1" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_DHEAD_ATTN_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DHEAD_ATTN_QKV,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DHEAD_ATTN_OUT,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DHEAD_FFN_NORM,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_DHEAD_FFN_UP,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DHEAD_FFN_DOWN,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_QTYPE_EMBD,                 {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_GET_ROWS}},
    {LLM_TENSOR_CLASS_PROJ_1,               {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
