...
enum llm_kv {
    ...
    LLM_KV_DECISION_HEAD_BLOCK_COUNT,
    LLM_KV_DECISION_HEAD_QTYPE_TOKEN_IDS,
    LLM_KV_DECISION_HEAD_QTYPE_TOKEN_INDEX,
    LLM_KV_DECISION_HEAD_CALIBRATION_TEMPERATURE,
    LLM_KV_DECISION_HEAD_SLOT_TOKEN_ID,
    LLM_KV_DECISION_HEAD_POINTER_DIM,
...
enum llm_tensor {
    ...
    LLM_TENSOR_CLS_OUT,
    LLM_TENSOR_CLS_NORM,
    LLM_TENSOR_DHEAD_ATTN_NORM,
    LLM_TENSOR_DHEAD_ATTN_QKV,
    LLM_TENSOR_DHEAD_ATTN_OUT,
    LLM_TENSOR_DHEAD_FFN_NORM,
    LLM_TENSOR_DHEAD_FFN_UP,
    LLM_TENSOR_DHEAD_FFN_DOWN,
    LLM_TENSOR_QTYPE_EMBD,
    LLM_TENSOR_CLASS_PROJ_1,
    LLM_TENSOR_CLASS_PROJ_2,
    LLM_TENSOR_TEXT_PROJ_1,
    LLM_TENSOR_TEXT_PROJ_2,
    LLM_TENSOR_POINTER_Q,
    LLM_TENSOR_POINTER_K,
    LLM_TENSOR_SCORER_NORM,
    LLM_TENSOR_SCORER,
    LLM_TENSOR_SCORER_OUT,
    LLM_TENSOR_CONV1D,
